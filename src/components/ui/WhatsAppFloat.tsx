...
export default function WhatsAppFloat() {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute left-[70px] bg-white text-slate-800 text-sm font-semibold px-4 py-2 rounded-lg shadow-lg opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 pointer-events-none whitespace-nowrap">
        ¡Hablemos!
        {/* Tooltip triangle */}
        <span className="absolute top-1/2 -left-2 -translate-y-1/2 border-[6px] border-transparent border-r-white"></span>
      </span>
    </Link>
  );
}
